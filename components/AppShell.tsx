...
export function AppShell({
  ...
  return (
    <div className="relative z-10 mx-auto flex min-h-screen w-full flex-col md:flex-row lg:max-w-[1400px]">
      ...
      <main className="order-1 flex flex-1 flex-col overflow-y-auto pb-[var(--mobile-nav-h)] md:order-2 md:pb-0">{children}</main>
      <MobileNav />
    </div>
  );
}
