...
function buildPerfumeAnalysisSystemPrompt({ isPro, perfumeContext }) {
  ...
  const isPerfumeRule =
    'CRITICAL — is_perfume ALANI:\n' +
    'JSON cevabinda is_perfume alani ZORUNLUDUR.\n' +
    'is_perfume: TRUE → yalnizca giyilebilir parfumler: EDT, EDP, Parfum, Extrait, Cologne, EDC.\n' +
    'is_perfume: FALSE → asagidaki urun turleri KESINLIKLE false:\n' +
    '  - Deodorant, vücut spreyi (Axe, Rexona, Dove, Lynx gibi markalar dahil)\n' +
    '  - Oda spreyi, ev kokusu, hava tazeleyici (room spray, home spray, air freshener)\n' +
    '  - Dus jeli, losyon, vucut kremi, mum\n' +
    'ORNEK: Axe Dark Temptation deodorant gorundugunde → is_perfume: false\n' +
    'ORNEK: Zara Home oda spreyi gorundugunde → is_perfume: false';
  ...
  const confidenceRule =
    ...
    '- KRITIK: Sise uzerinde hicbir marka etiketi veya isim gorunmuyorsa: confidenceScore 40 ALTI ver ve name="Unknown Fragrance" yaz.';

  const brandRule =
    'MARKA (brand) KURALI — ZORUNLU:\n' +
    '- brand alani her zaman dolu olmali. Parfumu tanimlayabiliyorsan markasini mutlaka yaz.\n' +
    '- Ornekler: Lancôme, Carolina Herrera, Avon, Oriflame, Zara, Dior, Chanel, Giorgio Armani.\n' +
    '- Emin oldugun durumlarda brand icin asla null donme.';
  ...
  const notesRule =
    ...
    '- Notalari her zaman en belirgin (prominent) ilk gelecek sekilde sirala.\n' +
    '- Ayni parfumu tekrar analiz etseydin ayni siralamayi kullan; tutarli ol.';
