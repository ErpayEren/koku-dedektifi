...
function buildPerfumeAnalysisSystemPrompt({ isPro, perfumeContext }) {
  ...
  const isPerfumeRule =
    'CRITICAL — is_perfume KURALI:\n' +
    'is_perfume yalnizca giyilebilir parfumler icin TRUE olmali: EDT, EDP, Parfum, Extrait, Cologne, EDC.\n' +
    'Asagidaki urun turleri icin is_perfume MUTLAKA FALSE olmali:\n' +
    '- Deodorant, vücut spreyi, antiperspirant\n' +
    '- Oda spreyi, ev kokusu, hava tazeleyici\n' +
    '- Dus jeli, losyon, vucut kremi, mum\n' +
    'Eger gorsel bir deodorant veya oda spreyi gosteriyorsa: is_perfume=false, confidenceScore=80+ ile dondur.';
